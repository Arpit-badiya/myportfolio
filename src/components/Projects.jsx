...
const PROJECTS = [
  ...
  },
  {
    id: 2,
    num: '02',
    title: 'Battle-8 Fantasy Esports',
    desc: 'A full-scale esports fantasy platform featuring multi-game contests, live rankings, secure wallet management, Google authentication, real-time updates, and scalable admin controls built for competitive gaming communities.',
    tags: ['React Native', 'Express.js', 'MongoDB', 'Firebase', 'Socket.IO', 'Render'],
    from: '#06b6d4',
    to: '#8b5cf6',
    live: 'https://arpit-badiya.github.io/Battle-8/',
    code: '#',
  },
  {
    id: 3,
